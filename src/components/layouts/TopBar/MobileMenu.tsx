...
import { FaBars, FaEnvelope, FaLocationDot, FaPhoneVolume, FaXmark, FaArrowRight } from 'react-icons/fa6'
          ...
          <Col xs={12}>
            <div className="mobile-header-elements">
              <div className="mobile-logo">
                <Link href="/home"><Image src={logo1} alt='logo1' /></Link>
              </div>
      ...
      <div className={`mobile-sidebar mobile-sidebar1 ${isOpen ? 'mobile-menu-active' : ''}`}>
        ...
        <div className="mobile-nav mobile-nav1">
          ...
          <div className="allmobilesection">
            <Link href="/pages/contacts" className="header-mobile-btn1">Get Started <span><FaArrowRight /></span></Link>

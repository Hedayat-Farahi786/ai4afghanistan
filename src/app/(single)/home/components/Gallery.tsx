                ...
                <div className="vl-gallery-content mb-60">
                    ...
                    <div className="vl-gallery-btn text-end" data-aos="fade-left" data-aos-duration={900}
                        ...
                        <div className="btn-area">
                            <Link href="/event-single" className="header-btn1">Vineyard
                    ...
                    <Row>
                        <Col lg={6} md={6} className="mb-30">
                            <div className="vl-single-box" data-aos="zoom-in-up" data-aos-duration={800}
                                 data-aos-delay={300}>
                                <Image className="w-100" src={galleryImg1} alt='galleryImg1'/>
                                <a href={galleryImg1.src}
                                   className="glightbox search-ic">
                                    <span><Image src={gallerySearch} alt='gallerySearch'/></span>
                                </a>
                            </div>
                        </Col>
                        <Col lg={6} md={6} className="mb-30">
                            <div className="vl-single-box" data-aos="zoom-in-up" data-aos-duration={900}
                                 data-aos-delay={300}>
                                <Image className="w-100" src={galleryImg2} alt='galleryImg2'/>
                                <a href={galleryImg2.src}
                                   className="glightbox search-ic">
                                    <span><Image src={gallerySearch} alt='gallerySearch'/></span>
                                </a>
                            </div>
                        ...
                        <Col lg={6} md={6} className="mb-30">
                            <div className="vl-single-box" data-aos="zoom-in-up" data-aos-duration={1000}
                                 data-aos-delay={300}>
                                <Image className="w-100" src={galleryImg3} alt='galleryImg3'/>
                                <a href={galleryImg3.src}
                                   className="glightbox search-ic">
                                    <span><Image src={gallerySearch} alt='gallerySearch'/></span>
                                </a>
                            </div>
                        ...
                        <Col lg={6} md={6} className="mb-30">
                            <div className="vl-single-box" data-aos="zoom-in-up" data-aos-duration={1100}
                                 data-aos-delay={300}>
                                <Image className="w-100" src={galleryImg4} alt='galleryImg4'/>
                                <a href={galleryImg4.src}
                                   className="glightbox search-ic">
                                    <span><Image src={gallerySearch} alt='gallerySearch'/></span>
                                </a>
                            </div>
                        ...
                        <Col lg={6} md={6} className="mb-30">
                            <div className="vl-single-box" data-aos="zoom-in-up" data-aos-duration={1200}
                                 data-aos-delay={300}>
                                <Image className="w-100" src={galleryImg5} alt='galleryImg5'/>
                                <a href={galleryImg5.src}
                                   className="glightbox search-ic">
                                    <span><Image src={gallerySearch} alt='gallerySearch'/></span>
                                </a>
                            </div>
                        ...
                        <Col lg={6} md={6} className="mb-30">
                            <div className="vl-single-box" data-aos="zoom-in-up" data-aos-duration={1300}
                                 data-aos-delay={300}>
                                <Image className="w-100" src={galleryImg6} alt='galleryImg6'/>
                                <a href={galleryImg6.src}
                                   className="glightbox search-ic">
                                    <span><Image src={gallerySearch} alt='gallerySearch'/></span>
                                </a>
                            </div>
